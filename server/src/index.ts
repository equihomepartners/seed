...
app.get('/api/check-access', async (req: Request, res: Response) => {
  ...
  const hardcodedUsers = ['taurian@equihome.com.au', 'namb.jay@gmail.com', 'vmenon1309@yahoo.co.uk', 'ian@equihome.com.au', 'kaden@fundlaunchpartners.com', 'acquisitions@fundlaunchpartners.com'];
